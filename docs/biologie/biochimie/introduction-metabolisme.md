Objectif : comprendre comment l'énergie et la matière circulent dans le vivant.
...
__Voie métabolique__séquence d'étapes au cours desquelles une même molécule est modifiée.
...
__Énergie__ capacité de changer la disposition de la matière.
...
!!! note
L'énergie pénètre sous forme de lumière dans un
...
!!! note
Pour réaliser la catalyse la cellule a besoin de
dépenser de l'ATP.
...
* La respiration cellulaire (présence de O~2~).
* La fermentation (absence de O~2~).
...
En moyenne les protéines sont capables de catalyser jusqu'a 1000 réactions par seconde. Un léger changement de quantités peut avoir des
répercussion importantes.

!!! note
En 2015, 4 000 enzymes découvertes
...
*  Étant participant à la réaction. Il y a modification de l'enzyme par la création d'une liaison covalente avec l'enzyme. A la fin de la réaction, l'enzyme retrouve sa forme initiale.
...
Coopérativité la fixation d'un substrat stabilise l'enzyme et augmente son affinité avec le substrat. Cela permet, par exemple, à l'hémoglobine de fixer l'O~2~, là où il présent en forte concentration, plus rapidement et efficacement. Inversement, de le libérer dans les tissus, là où elle est faible.
...
La rupture d'une liaison phosphate-phosphate comme pour l'hydrolyse de l'ATP libère $G'^0 = 30,5 kJ \cdot mol^{-1} = 7 \cdot 3 kcal \cdot mol^{-1}$ en condition standard ($1atm$ et 25 C°) et $G'^0 = - 50$ $kJ.{mol}^{- 1}$ à
37 °C.
