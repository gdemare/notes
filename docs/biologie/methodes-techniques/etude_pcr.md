...
* Relative connaitre la quantité par rapport à un autre échantillon. Par exemple, pour connaitre le niveau d'expression d'un gène entre d'un malade et d'un patient sain. C'est la méthode qui permet une meilleure reproductibilité des résultats.
* Absolu connaitre la quantité de façon absolue. Par exemple pour quantifier des protéines virales.
